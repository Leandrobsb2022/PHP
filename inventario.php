...
if(isset($_POST['loc_emp'])) 
  			{	
				...
				$cnpj= $_POST['cmbemp'];
				$query = mysql_query("SELECT * FROM `empre` WHERE  cnpj='$cnpj'");
...
<select name="cmbcnpj2" id="cmbcnpj2" required="required" >
  <option ></option>
  <?php
		$sql = mysql_query("SELECT cnpj FROM empre");
...
<select name="cmbnfe2" id="cmbnfe2">
 <option></option>
  <?php
		$sql = mysql_query("SELECT id_nf FROM nf");
...
<br />
    ...
    <label for="label4">
          <select name="tip2" id="tip2" value="" required>
            <option></option>
            <?php
		$sql = mysql_query("SELECT tip_prod FROM tip");
      ...
      <th width="296" scope="col"><em>
        ...
        <option></option>
          <?php
		$sql = mysql_query("SELECT situa FROM situac");
